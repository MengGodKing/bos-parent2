...
<script type="text/javascript">
	...
	function doAssociations(){
        var selectedItem = $("#grid").datagrid("getSelections");

		if (selectedItem.length!=1){
            $.messager.alert("提示","请选择一个定区操作","warning");
        }else {
            $("#noassociationSelect").empty();
            $("#associationSelect").empty();
            $('#customerWindow').window('open');

            var url = "decidedzoneAction_findListNotAssociation.action";
            ...
            var url2 = "decidedzoneAction_findListHasAssociation.action";
            var decideid = selectedItem[0].id;
	...
	function doDblClickRow(rowIndex, rowData){
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "subareaAction_findSubareList?decidedzoneid="+rowData.id,
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addForm" action="decidedzoneAction_add.action" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'subareaAction_listAjx.action',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
